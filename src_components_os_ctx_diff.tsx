--- src/components/os/ctx.tsx (原始)
import { createContext, useContext, useEffect, useState } from "react";
import type { ThemeName } from "../../lib/os-data";

export type WinId = "about" | "projects" | "terminal" | "viewer" | "readme" | "cms" | "blog";
...
+++ src/components/os/ctx.tsx (修改后)
import { createContext, useContext, useEffect, useState } from "react";
import type { ThemeName } from "../../lib/os-data";

export type WinId =
  | "about" | "projects" | "terminal" | "viewer" | "readme" | "cms" | "blog"
  | "article" | "game" | "scores";
...
export interface OSApi {
  ...
  focus: (id: WinId) => void;
  move: (id: WinId, x: number, y: number) => void;
  resize: (id: WinId, patch: Partial<Pick<WinState, "x" | "y" | "w" | "h">>) => void;
  openViewer: (slug: string) => void;
